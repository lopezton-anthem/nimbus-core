 ...
 *
 */
public class PlatformMarkerResolver extends CrossDomainKeywordResolver {
	
	public PlatformMarkerResolver(String keyword, CommandExecutorGateway executorGateway) {
